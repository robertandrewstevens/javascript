---
title: "EloquentJavaScript00.Rmd"
...
*Eloquent JavaScript* is a digital book providing a comprehensive introduction (tutorial) to the JavaScript programming language. Apart from a bookfull of text, it contains plenty of example programs, and an environment to try them out and play with them.  
